...
import { EvidencePopup } from '../components/game/EvidencePopup';
import { DialoguePopup } from '../components/game/DialoguePopup';
    ...
    return (
        <div className="relative w-full h-screen bg-black overflow-hidden">
            ...
            For this hackathon, full screen relative positioning is easiest */}
                ...
                {/* ADVISORS */}
                {eraData.advisors.map((advisor, index) => (
                    <motion.button
          ...
          `}
            ...
            {/* 5. Popups Layer */}
            <AnimatePresence>
                {activePopup === 'evidence' && <EvidencePopup key="evidence-popup" />}
                {activePopup === 'advisor' && <DialoguePopup key="dialogue-popup" />}
            </AnimatePresence>
        </div>
    );
};